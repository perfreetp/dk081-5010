...
export const mockParts: Part[] = [
  {
    ...
    status: 'in_stock', photos: [], inboundDate: d(12),
  ...
  },
  {
    ...
    status: 'in_stock', photos: [], inboundDate: d(17),
  ...
  },
  {
    ...
    status: 'sold', photos: [], inboundDate: d(17),
  ...
  },
  {
    ...
    status: 'in_stock', photos: [], inboundDate: d(25),
...
export const mockQuotes: Quote[] = [
  {
    ...
    items: [
      { partId: 'P1', partName: 'EA888发动机总成', sku: 'VW-PST-21-ENG-001', quantity: 1, unitPrice: 26600, originalPrice: 28000, discount: 1400, subtotal: 26600, warrantyDays: 90, remark: '' },
      { partId: 'P3', partName: '左前大灯总成', sku: 'VW-PST-21-LHD-001', quantity: 2, unitPrice: 2024, originalPrice: 2200, discount: 352, subtotal: 4048, warrantyDays: 30, remark: '' }
    ],
  ...
  },
  {
    ...
    items: [
      { partId: 'P4', partName: 'MR20发动机总成', sku: 'NS-TL-20-ENG-001', quantity: 1, unitPrice: 15300, originalPrice: 18000, discount: 2700, subtotal: 15300, warrantyDays: 90, remark: '' }
    ],
  ...
  },
  {
    ...
    items: [
      { partId: 'P6', partName: '主驾座椅总成', sku: 'FD-MD-19-SEB-001', quantity: 1, unitPrice: 950, originalPrice: 950, discount: 0, subtotal: 950, warrantyDays: 30, remark: '' }
    ],
